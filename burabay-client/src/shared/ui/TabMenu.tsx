...
export const TabMenu: FC<Props> = function TabMenu(props) {
    ...
    const styles = `columns-${props.data.length} gap-0 flex w-100 ${COLORS_BACKGROUND.accent100} rounded-tabs p-0.5 ${props.className}`
    ...
    const renderItem = useCallback(
        (item:TabMenuItem) =>(
            <Typography
                ...
                weight={700}
                size={16}
                color={props.activeIndex === item.index ? COLORS_TEXT.alternative : COLORS_TEXT.primary}
