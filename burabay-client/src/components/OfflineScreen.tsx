    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-white px-6">
      <div className="max-w-md w-full text-center">
        <div className="flex justify-center mb-6">
          ...
          >
            <path d="M2 8.82C6.5 5 17 5 21.5 8.82C6.5" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/>
            ...
            <path d="M1 3L22 18" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </div>
