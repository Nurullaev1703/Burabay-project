...
export class ImagesController {
  ...
  async uploadImage(@UploadedFile() file: Express.Multer.File, @Param('directory') directory:string) {
  ...
  async uploadFile(@UploadedFiles() files: Array<Express.Multer.File>, @Param('directory') directory:string) {
